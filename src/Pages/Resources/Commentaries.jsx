...
const commentaries = [
  {
    ...
    description:
      "A monumental commentary that systematically establishes the philosophy of non-dualism (Advaita), interpreting the aphorisms of the Brahma Sūtras to show the identity of the individual self (Ātman) with the ultimate reality (Brahman).",
    color: "amber",
  },
  {
    ...
    school: "Yoga",
    description:
      "The foundational commentary on the Yoga Sūtras, providing the most authoritative and traditional explanation of Patañjali's aphorisms on the practice of yoga, the nature of the mind, and the path to liberation.",
    color: "teal",
  },
  {
    ...
    school: "Nyāya",
    description:
      "The first and most important commentary on the Nyāya Sūtras, which elaborates on the principles of logic, epistemology, and debate, forming the bedrock of the Nyāya school of classical Indian philosophy.",
    color: "rose",
  },
];
        ...
        <div className="container mx-auto px-6 text-center">
          <motion.div initial="hidden" animate="visible" variants={fadeIn}>
            ...
            <p className="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">
              Discover the tradition of Bhāṣya (commentary), where generations
              of scholars have illuminated the dense wisdom of foundational
              texts, shaping the evolution of Indian philosophy.
            </p>
          </motion.div>
        </div>
      </header>
        ...
        >
          {commentaries.map((item) => (
            ...
            >
              <div className="p-8">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                  ...
                  <div className="md:col-span-5 lg:col-span-4 text-center md:text-left">
                    ...
                    <h3 className="mt-4 text-xl font-serif text-slate-800">
                      Original Text
                    </h3>
                  ...
                  <div className="md:col-span-5 lg:col-span-7 text-center md:text-left">
                    <div
                      className={`inline-block bg-${item.color}-100 p-4 rounded-full`}
                    >
                      <ChatBubbleLeftRightIcon
              ...
              <div
                className={`bg-${item.color}-50 border-t border-${item.color}-200 p-8`}
              >
                <p className="text-slate-700 leading-relaxed">
                  {item.description}
                </p>
                <div
                  className={`mt-4 text-xs font-semibold uppercase tracking-wider text-${item.color}-700 bg-${item.color}-100 py-1 px-3 rounded-full inline-block`}
                >
                  {item.school}
                </div>
              </div>
